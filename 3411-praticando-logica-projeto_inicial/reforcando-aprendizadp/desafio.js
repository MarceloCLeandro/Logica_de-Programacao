...
console.log('Número 159');
console.log(validarNumero(159));
console.log('Número -99');
console.log(validarNumero(-99));
console.log('Aqui foi digitado 0');
...
// Exemplo de uso
const outroArray = [10, 20, 30, 40, 50];
const elementoProcurado = 30;

// Utilizando a função para verificar a presença do elemento no array
const elementoEstaPresente = verificarElementoNoArray(outroArray, elementoProcurado);
